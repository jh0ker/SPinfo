...
namespace Awesome
{
    class Program
    {
        ...
        static async void Bot_OnMessage(object sender, MessageEventArgs e)
        {
            ...
            var regex = new Regex(@"^(([0-4]+[0-9]+[0-9])|([0-9]+[0-9])|([0-9]))$");
            ...
            List<string> subscribed = new List<string>(System.IO.File.ReadAllLines(@"foo.txt"));
            ...
            if (e.Message.Text != null)
            {
                ...
                else if (regex.IsMatch(e.Message.Text))
                {
                    ...
                    if (baseStats[3, pokedex] == -1)
                    {
                        await botClient.SendTextMessageAsync(
                          chatId: e.Message.Chat,
                          text: pkmname[1, pokedex] + " ist schon die höchste Entwicklung.",
                          parseMode: ParseMode.Markdown
                        );
                    }
                    else
                ...
                else if (e.Message.Text == "/subscribe")
                {
                    ...
                    if (havesubscribed == false)
                    {
                        ...
                        System.IO.File.WriteAllLines("foo.txt", subscribed);
                        await botClient.SendTextMessageAsync(
